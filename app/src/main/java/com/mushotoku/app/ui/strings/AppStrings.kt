...
class AppStrings(private val ctx: Context) {
    ...
    val currencyCustom get() = s(R.string.currency_custom)
    val currencyCustomMenu get() = s(R.string.currency_custom_menu)
    val currencyCustomTitle get() = s(R.string.currency_custom_title)
    val currencyCustomSymbol get() = s(R.string.currency_custom_symbol)
    val currencyCustomPosition get() = s(R.string.currency_custom_position)
    val currencyCustomPositionBefore get() = s(R.string.currency_custom_position_before)
    val currencyCustomPositionAfter get() = s(R.string.currency_custom_position_after)
    val currencyCustomSpace get() = s(R.string.currency_custom_space)
    val currencyCustomDecimals get() = s(R.string.currency_custom_decimals)
    val currencyCustomDecimalsTwo get() = s(R.string.currency_custom_decimals_two)
    val currencyCustomDecimalsNone get() = s(R.string.currency_custom_decimals_none)
    val currencyCustomSeparator get() = s(R.string.currency_custom_separator)
    val currencyCustomSeparatorDot get() = s(R.string.currency_custom_separator_dot)
    val currencyCustomSeparatorComma get() = s(R.string.currency_custom_separator_comma)
    val currencyCustomPreview get() = s(R.string.currency_custom_preview)
    ...
    val notesInsertTimestamp get() = s(R.string.notes_insert_timestamp)
    val notesListDash get() = s(R.string.notes_list_dash)
    val notesListBullet get() = s(R.string.notes_list_bullet)
