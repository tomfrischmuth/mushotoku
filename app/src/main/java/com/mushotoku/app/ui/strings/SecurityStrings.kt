...
internal class SecurityStrings(
    ...
    val recoverySetup: String,
    val recoveryRegenerate: String,
    val recoveryHint: String,
    val switchToBiometric: String,
    val switchToBiometricHint: String,
    val switchToBiometricMessage: String,
    val newLockTitle: String,
    val newLockMessage: String,
    val newLockBiometric: String,
    val newLockNone: String,
...
internal fun securityStrings(ctx: Context): SecurityStrings = SecurityStrings(
    ...
    recoverySetup = ctx.getString(R.string.sec_recovery_setup),
    recoveryRegenerate = ctx.getString(R.string.sec_recovery_regenerate),
    recoveryHint = ctx.getString(R.string.sec_recovery_hint),
    switchToBiometric = ctx.getString(R.string.sec_switch_to_biometric),
    switchToBiometricHint = ctx.getString(R.string.sec_switch_to_biometric_hint),
    switchToBiometricMessage = ctx.getString(R.string.sec_switch_to_biometric_message),
    newLockTitle = ctx.getString(R.string.sec_new_lock_title),
    newLockMessage = ctx.getString(R.string.sec_new_lock_message),
    newLockBiometric = ctx.getString(R.string.sec_new_lock_biometric),
    newLockNone = ctx.getString(R.string.sec_new_lock_none),
    wrongPassphrase = ctx.getString(R.string.wrong_passphrase),
