...
val DEFAULT_CATEGORIES: List<Category> = listOf(
    ...
    Category("lieferdienst",     "Lieferdienst",               "Essen & Trinken",       isEnabled = false, sortOrder =  17),
    Category("kantine",          "Kantine",                    "Essen & Trinken",       isEnabled = false, sortOrder =  18),
    Category("bar",              "Bar",                        "Essen & Trinken",       isEnabled = false, sortOrder =  19),
    ...
    Category("wellness",         "Wellness",                   "Gesundheit & Körper",   isEnabled = true,  sortOrder =  38),
    Category("kleidung",         "Kleidung",                   "Kleidung & Accessoires",isEnabled = false, sortOrder =  39),
    ...
    Category("accessoires",      "Accessoires",                "Kleidung & Accessoires",isEnabled = false, sortOrder =  42),
    ...
    Category("events",           "Events",                     "Freizeit",              isEnabled = false, sortOrder =  45),
    ...
    Category("lesestoff",        "Lesestoff",                  "Freizeit",              isEnabled = false, sortOrder =  48),
    ...
    Category("schwimmbad",       "Schwimmbad",                 "Sport",                 isEnabled = false, sortOrder =  54),
    Category("outdoor_sport",    "Outdoor-Sport",              "Sport",                 isEnabled = false, sortOrder =  55),
    Category("indoor_sport",     "Indoor-Sport",               "Sport",                 isEnabled = false, sortOrder =  56),
    ...
    Category("spenden",          "Spenden",                    "Soziales",              isEnabled = false, sortOrder =  76),
    Category("geschenke",        "Geschenke",                  "Soziales",              isEnabled = false, sortOrder =  77),
